 ...
 */
public class HomePageRecLiveAdapter extends BaseQuickAdapter<HomePage.RecLiveBean.DataListBean.MyArrayListBean> {
    public HomePageRecLiveAdapter(int layoutResId, List<HomePage.RecLiveBean.DataListBean.MyArrayListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, HomePage.RecLiveBean.DataListBean.MyArrayListBean myArrayListBean) {

        baseViewHolder.setText(R.id.tv_game_name, myArrayListBean.getMap().getName());
        if (myArrayListBean.getMap().getTitle()!=null){
